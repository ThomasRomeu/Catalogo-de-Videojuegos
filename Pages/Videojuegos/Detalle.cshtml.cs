...
namespace primerParcial.Pages.Videojuegos
{
    ...
    {
        [BindProperty]
        public Videojuego VideojuegoDet { get; set; }
        ...
        public DetalleModel(IVideojuegoServicio videojuegoSrv, IPlataformaServicio platsrv, IEmpresaServicio empSrv)
        {
        ...
        public void OnGet(int id)
        {
            ...
            VideojuegoDet = lista.Where(x => x.Id == id).First();
